...
export const TracingBeam = ({
  ...
  // 1 to 1 ratio scroll
  const scrollY = useTransform(scrollYProgress, [0, 1], [0, svgHeight]);
  
  // head
  const y1 = scrollY;
  
  // tail + length of the beam
  const y2 = useTransform(scrollY, (value) => value - 750); 
      ...
      <div className="absolute top-3 -left-4 md:-left-20">
        ...
        >
          <motion.div
            ...
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? "white" : "hsl(var(--primary))",
              borderColor: scrollYProgress.get() > 0 ? "white" : "hsl(var(--primary))",
            }}
