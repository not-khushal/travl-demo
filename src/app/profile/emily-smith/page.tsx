...
export default function EmilySmithProfilePage() {
  ...
  const emilyFriendsData: Friend[] = [
      { id: 'r1', name: 'Alex H. (Host)', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=48&h=48&fit=crop', avatarAiHint: 'person face friendly' },
      { id: 'r2', name: 'Maria L. (Traveler)', avatarUrl: 'https://images.unsplash.com/photo-1521146764736-56c929d59c83?q=80&w=48&h=48&fit=crop', avatarAiHint: 'person face kind'},
      { id: 'r3', name: 'Chen W. (Host)', avatarUrl: 'https://images.unsplash.com/photo-1528892952291-009c663ce843?q=80&w=48&h=48&fit=crop', avatarAiHint: 'person face happy' },
  ];
  ...
  const emilyFeedItems: FeedItem[] = [
    ...
    },
    {
    ...
    },
     {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1529963172242-d6162a04b17f?q=80&w=1200&auto=format&fit=crop',
